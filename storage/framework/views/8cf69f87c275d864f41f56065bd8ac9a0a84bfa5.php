                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group<?php echo e($errors->has('item_price') ? ' has-danger' : ''); ?>">
                                            <label style="float: left; width: 100%;" class="form-control-label" for="item_price"><?php echo e(__('Item Price')); ?></label>
                                            <input style="width: 65%; float: left; margin-right: 5%;" type="number" step="any" name="item_price" id="item_price" class="form-control form-control-alternative<?php echo e($errors->has('item_price') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Price')); ?>" value="<?php echo e(old('item_price', $item->price)); ?>" required autofocus>
                                            <div style=" width: 30%; margin-top: 12px; float: left; "><input type="checkbox" id="somavel" value="Item não somável"><label for="somavel">Item não somável</label></div>
                                        ...
                                        <label class="custom-toggle" style="float: right">
                                            <input type="checkbox" name="itemOrcamento" id="itemOrcamento">
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/test.com/html/laravel/resources/views/items/edit.blade.php ENDPATH**/ ?>