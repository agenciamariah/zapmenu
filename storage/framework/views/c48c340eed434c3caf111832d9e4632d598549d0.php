            ...
            <div class="col-lg-5 col-md-7">
                ...
                <div class="row mt-3">
					...
					<div class="col-7" style="text-align: right;">
                                                    <a href="https://app.zapentrega.com/new/r/register" class="text-light">
                               			 <small>Não tem conta ainda? Teste grátis agora!</small>
                           			 </a>
                                            </div>
                    <?php if(config('app.isft')): ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/test.com/html/laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>