<div class="card card-profile shadow">
    <div class="px-4">
      <div class="mt-5">
        <h3><span class="delTime delTimeTS"><?php echo e(__('Delivery time')); ?></span><span class="picTime picTimeTS"><?php echo e(__('Hora da reserva da mesa')); ?></span><span class="font-weight-light"></span></h3>
      </div>
  ...
  <br />
<?php /**PATH /var/www/test.com/html/laravel/resources/views/cart/time.blade.php ENDPATH**/ ?>