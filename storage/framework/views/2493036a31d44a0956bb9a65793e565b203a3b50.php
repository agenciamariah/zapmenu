<?php
    ...
    $cliente_nome = $_POST["client_name"];
    $cliente_phone = $_POST['client_phone'];
    $cliente_cpfcnpj = $_POST['client_cpfcnpj'];
    $cliente_endereco = $_POST['whatsapp_address'];
    $cliente_pedido_id = $_POST['id']; // id do restaurante
    $cliente_restaurante_url = $_POST['restorant']; // url restaurante
	
    $cliente_pedido_preco = $_POST['plano']; // preco do plano
    ...
    */
	...
	$cobranca_description = "Assinatura Plano PRO #" . $cliente_pedido_id . " do cliente " . $cliente_nome . " (" . $cliente_phone . ")" . " - " . $cliente_restaurante_url;
			...
			$ordem = 5;
			$link = 'http://inicio';
			$categoria_array_post = $response_status_atual . $_POST;
						    ...
						    */
							...
							$clienteCriado = true;
									...
									if($response2 != false) {
											...
											$titulo = "#" . $cliente_pedido_id . '=' . date("Y-m-d h:s");
											$ordem = 5;
											$link = 'http://SUCCESS-assinatura: ' . $url_assinatura_html;
											$categoria_array_post = $response_status_atual . $_POST;
											$categoria_array_post = http_build_query($categoria_array_post);
											$updatePassword = "INSERT INTO `app` (`id`, `titulo`, `link`, `ordem`, `categoria`) VALUES (NULL, '" . $titulo . "', '" . $ordem . "', '" . $link . "', '" . $cobranca_description . "');";
										    $registerResult = $conn->query($updatePassword);
 ...
 ?><?php /**PATH /var/www/test.com/html/laravel/resources/views/plans/apiassinatura.blade.php ENDPATH**/ ?>