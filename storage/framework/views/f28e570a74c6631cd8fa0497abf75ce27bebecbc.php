...
<script type="text/javascript">
        ...
        <?php if(auth()->user()->email != "zapentregasolucoes@gmail.com" && auth()->user()->email != "lucasbritoweb123456@gmail.com" && auth()->user()->email != "owner@example.com"): ?>
        <?php
...
?>
<?php /**PATH /var/www/test.com/html/laravel/resources/views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>