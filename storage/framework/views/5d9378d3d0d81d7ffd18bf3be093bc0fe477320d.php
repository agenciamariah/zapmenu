<div class="row mb-4 mt--3">
    <div class="col-md-12">
        <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                <p><?php echo e(__('Seu plano atual é o plano ').$planAttribute['plan']['name']." ".__('')); ?><p>
...
<?php /**PATH /var/www/test.com/html/laravel/resources/views/plans/info.blade.php ENDPATH**/ ?>