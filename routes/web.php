...
Route::post("/apiassinatura", function(){
    return view('plans/apiassinatura');
});

Route::get("/apiassinatura", function(){
    return view('plans/apiassinatura');
});


Route::get('/subscribe/update', 'PlansController@adminupdate')->name('update.plan');
Route::post('/subscribe/plano', 'PlansController@subscribe')->name('plans.subscribe');
...
Route::get('/r/register', 'RestorantController@showRegisterRestaurant')->name('newrestaurant.register');
