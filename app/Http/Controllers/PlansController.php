...
class PlansController extends Controller
{
    ...
    public function createapi(Request $request)
    {
      ...
      $thePOST = $request->all();
      // dd($thePOST);      
	return view('plans.createapi',['thePOST' =>$thePOST]);
    }


    public function createapicredit(Request $request)
    {
        // $this->adminOnly();
        $thePOST = $request->all();

        return view('plans.createapicredit',['thePOST'=>$thePOST]);
    }
    ...
    public function show($id)
    {
        ...
        return view('plans.createapi',['theSelectedProcessor'=>$theSelectedProcessor]);
	//self::createapi();
        //
    }
