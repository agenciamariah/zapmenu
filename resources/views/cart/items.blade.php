        ...
        <div  id="cartList" class="border-top">
            ...
            <div  v-for="item in items" class="items col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
                <div class="info-block block-info clearfix" v-cloak>
                    ...
                    <p class="product-item_quantity item-type-@{{ item.attributes.item_orcamento }}">@{{ item.quantity }} x @{{ item.attributes.friendly_price }}</p>
                    <p class="product-item_quantity item-type-@{{ item.attributes.item_orcamento }}">@{{ item.quantity }} x Orçamento</p>
                    <div class="row">
